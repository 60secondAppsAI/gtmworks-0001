...
export default {
  ...
  methods: {
    ...
    async onTableChange(pagination, filters, sorter) {
	  ...
	  this.$emit('get-all-teams',this.sortBy,this.sortOrder,this.pagination.current-1,this.pagination.pageSize);
    ...
    handleSearchQueryChanged() {
    	...
    	this.$root.$emit('searchQueryForTeamsChanged', this.searchQuery);
	...
	async handleAddSubmitted() {
      ...
      this.teamToAdd.created = currentDate;
