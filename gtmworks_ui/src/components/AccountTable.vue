    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'industryType',
          ...
          sorter: true
          //sorter: (a, b) => a.industryType - b.industryType,
		...
		dataIndex: 'annualRevenue',
          visible: true,
          scopedSlots: { customRender: 'annualRevenue' },
          sorter: true
          //sorter: (a, b) => a.annualRevenue - b.annualRevenue,
          //sorter: (a, b) => a.annualRevenue.localeCompare(b.annualRevenue),
        },
      ],
      pagination: {
        current: 1,
