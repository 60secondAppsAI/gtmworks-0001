					...
					<tr> 
						<td style="width: 100%;"></td>
				        	<td style="width: 150px;">
				      			<base-button class="btn btn-primary" @click="updateContact()">Save</base-button>
				        	</td>
				        	<td style="width: 150px;">
				        	<td style="width: 150px;">
								...
								<div >
								  <div class="container">
												    <base-button class="btn btn-primary" @click="modal2Contacts = true">Add</base-button>
								              <modal :show.sync="modal2Contacts">
          ...
          <a-modal :footer="null" :visible="userPermissionDialog" :closable="false" class="centered-modal" v-if="userPermissionDialog">
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
										...
										<tr> 
					<td class="detail_view_column_2">Contact Id</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactId" type="text" placeholder="Enter ContactId" v-model="contactDetails.contactId"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">First Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="FirstName" type="text" placeholder="Enter FirstName" v-model="contactDetails.firstName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Last Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="LastName" type="text" placeholder="Enter LastName" v-model="contactDetails.lastName"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Email</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Email" type="text" placeholder="Enter Email" v-model="contactDetails.email"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Phone Number</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="PhoneNumber" type="text" placeholder="Enter PhoneNumber" v-model="contactDetails.phoneNumber"></input>
																		</div>
						</td>
														</tr>
...
export default {
  ...
  methods: {
    ...
    async updateContact() {
      ...
      const jsonData = JSON.stringify(this.contactDetails);
      const res = await ContactService.update(jsonData);
...
//        this.getAllContacts();
    ...
    async getContactDetails() {
      try {
			let response = await ContactService.get(this.contactId);
