						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="IndustryType" type="text" placeholder="Enter IndustryType" v-model="accountToAdd.industryType"></base-input>
								  <base-input label="AnnualRevenue" type="text" placeholder="Enter AnnualRevenue" v-model="accountToAdd.annualRevenue"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Account Name</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Industry Type</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="IndustryType" type="text" placeholder="Enter IndustryType" v-model="accountDetails.industryType"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Annual Revenue</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="AnnualRevenue" type="text" placeholder="Enter AnnualRevenue" v-model="accountDetails.annualRevenue"></input>
																		</div>
						</td>
														</tr>
